                            ...
                            <div class="row g-4 align-items-center">
                                ...
                                <div class="col-sm-auto">
                                    <div class="d-flex flex-wrap align-items-start gap-2">
                                        <a class="btn btn-soft-success" href="{{ route('admin.ati.ati-source.create') }}">
                                ...
                                <table id="buttons-datatables"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('admin.ati.ati-source.show',$source)}}"><i
                                                        class="ri-eye-line align-bottom me-2 text-success"></i>
                                                <a href="{{route('admin.ati.ati-source.edit',$source->id)}}"><i
