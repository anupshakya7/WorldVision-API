...
@section('title','Domain Score Update')
@section('content')
<style>
    .error {
        color: red;
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">{{ 'Update Domain Score'}}</li>
                            </ol>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header border-bottom-dashed">
                            <h5 class="card-title mb-0">{{ 'Update Domain Score' }}</h5>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('admin.ati.domain-score.update',$countryData) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    <label for="domain_id">{{ 'Domain' }} <span
                                                        ...
                                                        name="domain_id">
                                                            ...
                                                            <option value="{{ $indicator->id }}" {{$countryData->domain_id == $indicator->id ? 'selected':''}}>{{ $indicator->variablename }}</option>
                                                            @endforeach
                                                        </select>
                                            ...
                                            <div class="col-12" style="margin-top:20px;">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="domain_result" class="form-control"
                                                            value="{{ old('domain_result',$countryData->domain_result) }}" placeholder="Domain Result">
                                            ...
                                            <div class="col-12" style="margin-top:20px;">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="trend_result" class="form-control"
                                                            value="{{ old('trend_result',$countryData->trend_result) }}" placeholder="Trend Result">
                                            ...
                                            <div class="col-12" style="margin-top:20px;">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="score" class="form-control"
                                                            value="{{ old('score',$countryData->score) }}" placeholder="Country Score">
                                                    @if($errors->has('score'))
                                                    <em class="invalid-feedback">
                                                        {{ $errors->first('score') }}
                                                    </em>
                                            ...
                                            <div class="col-12" style="margin-top:20px;">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="trend_percentage" class="form-control"
                                                            value="{{ old('trend_percentage',$countryData->trend_percentage) }}" placeholder="Domain Trend (%)">
                                            ...
                                            <div class="col-12" style="margin-top:20px;">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="shifts_governance" class="form-control"
                                                            value="{{ old('shifts_governance',$countryData->shifts_governance) }}" placeholder="Shifts in Governance">
