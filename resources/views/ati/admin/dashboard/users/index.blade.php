                            ...
                            <div class="row g-4 align-items-center">
                                ...
                                <div class="col-sm-auto">
                                    <div class="d-flex flex-wrap align-items-start gap-2">
                                        <a class="btn btn-soft-success" href="{{ route('admin.ati.users.create') }}">
                                ...
                                <table id="buttons-datatables"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('admin.ati.users.roles',$user)}}" class="btn btn-sm btn-primary">Roles</a>
                                                <a href="{{route('admin.ati.permissions.index')}}" class="btn btn-sm btn-danger">Permissions</a>
                                            </td>
                                            <td>
                                                <a href="{{route('admin.ati.users.show',$user)}}"><i
                                                        class="ri-eye-line align-bottom me-2 text-success"></i>
                                                    <a href="{{route('admin.ati.users.edit',$user)}}"><i
